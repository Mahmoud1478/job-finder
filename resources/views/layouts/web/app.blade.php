                    ...
                    <div class="col-lg-9 col-md-9">
                        <div class="menu-wrapper">
                            ...
                            <div class="main-menu">
                                <nav class="d-none d-lg-block">
                                    <ul id="navigation">
                                        ...
                                        <li><a href="{{route('find')}}">Find a Jobs </a></li>
                                    </ul>
                                </nav>
                            </div>
                            <!-- Header-btn -->
                            <div class="header-btn d-none f-right d-lg-block">
                                ...
                                @auth()
                                    <div class="dropdown">
                                        <a class="dropdown-toggle d-inline-block " href="javascript:void(0)"
                                           role="button"
                                           data-toggle="dropdown" aria-expanded="false" style="height: 60px">
                                            <img src="{{auth()->user()->image_url}}"
                                                 style="height: 100% !important; border-radius: 100% !important;"
