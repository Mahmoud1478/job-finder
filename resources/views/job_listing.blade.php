                ...
                <div class="col-xl-3 col-lg-3 col-md-4">
                    ...
                    <div class="job-category-listing mb-50">
                        ...
                        <div class="single-listing">
                            ...
                            <!-- Select job items start -->
                            <div class="select-job-items2">
                                <input type="text" class="form-control" value="{{request('location')}}" name="location">
                            </div>
                            <!--  Select job items End-->
                            <!-- select-Categories start -->
                            <div class="select-Categories pt-80 pb-50">
                                ...
                                <label class="container">All
                                    <input type="radio" name="experience_level"
                                           value="0" @checked(request('experience_level', 0) == 0)>
                                    <span class="checkmark"></span>
                                </label>
                                @foreach(ExperienceLevelEnum::cases() as $experience)
                                    ...
                                    <label class="container">{{$experience->toString()->ucfirst()}}
                                        <input type="radio" name="experience_level"
                                               value="{{$experience->value}}" @checked(request('experience_level', 0) == $experience->value)>
                                        <span class="checkmark"></span>
                                    </label>
                                @endforeach
                        ...
                        <div class="single-listing">
                            ...
                            <div class="select-Categories pb-50">
                                ...
                                <label class="container">Today
                                    <input type="radio" name="created_at"
                                           value="{{today()}}" @checked(request('created_at')==today())>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="container">Last 2 days
                                    <input type="radio" name="created_at"
                                           value="{{today()->subDays(2)}}" @checked(request('created_at') == today()->subDays(2))>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="container">Last 3 days
                                    <input type="radio" name="created_at"
                                           value="{{today()->subDays(3)}}" @checked(request('created_at') == today()->subDays(3))>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="container">Last 5 days
                                    <input type="radio" name="created_at"
                                           value="{{today()->subDays(5)}}" @checked(request('created_at') == today()->subDays(5))>
                                    <span class="checkmark"></span>
                                </label>
                                <label class="container">Last 10 days
                                    <input type="radio" name="created_at"
                                           value="{{today()->subDays(10)}}" @checked(request('created_at') == today()->subDays(10))>
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                            <!-- select-Categories End -->
                                    ...
                                    <div class="job-items">
                                        ...
                                        <div class="job-tittle job-tittle2">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <i class="fas fa-map-marker-alt"></i>{{Str::limit($job->location,20)}}
                                                </li>
