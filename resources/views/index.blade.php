            ...
            <div class="single-slider slider-height d-flex align-items-center"
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <!-- form -->
                            <form action="{{route('find')}}" id="search" class="search-box">
                                <div class="input-form">
                                    <input type="text" name="search" placeholder="Job Tittle or keyword">
                                </div>
                                <div class="select-form">
                                    <div class="input-form" style="width: 100%">
                                        <input type="text" style="width: 100%" name="location" placeholder="Job Tittle or keyword">
                                    </div>
                                </div>
                                <div class="search-form">
                                    <a href="#" onclick="submit()" role="button" type="submit" >Find job</a>
                                </div>
                            </form>
                        </div>
                    </div>
